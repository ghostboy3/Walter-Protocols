...
def run(protocol):
    ...
    left_pipette.pick_up_tip()
    for i in range (0,10):
        asp_height = find_aspirate_height(left_pipette, sample_tube)
        left_pipette.aspirate(50, sample_tube.bottom(asp_height))
        left_pipette.dispense(50, tube_rack["A2"].top())
    left_pipette.return_tip()
